...
public final class ControllableSplashParticle extends ControllableParticle {
    private final SpriteSet provider;

    public ControllableSplashParticle(ClientLevel world, Vec3 pos, Vec3 velocity,
    ...
    public static class Factory implements ParticleProvider<ControllableSplashEffect> {
        private final SpriteSet provider;
        ...
        @Override
        public Particle createParticle(ControllableSplashEffect parameters, ClientLevel world,
                                       double x, double y, double z,
                                       double velocityX, double velocityY, double velocityZ) {
            return new ControllableSplashParticle(world,
