...
public final class ControllableEnchantmentParticle extends ControllableParticle {
    private final SpriteSet provider;

    public ControllableEnchantmentParticle(ClientLevel world, Vec3 pos, Vec3 velocity,
    ...
    public static class Factory implements ParticleProvider<ControllableEnchantmentEffect> {
        private final SpriteSet provider;
        ...
        @Override
        public Particle createParticle(ControllableEnchantmentEffect parameters, ClientLevel world,
                                       double x, double y, double z,
                                       double velocityX, double velocityY, double velocityZ) {
            return new ControllableEnchantmentParticle(world,
