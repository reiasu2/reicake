...
public final class ControllableFireworkParticle extends ControllableParticle {
    private final SpriteSet provider;

    public ControllableFireworkParticle(ClientLevel world, Vec3 pos, Vec3 velocity,
    ...
    public static class Factory implements ParticleProvider<ControllableFireworkEffect> {
        private final SpriteSet provider;
        ...
        @Override
        public Particle createParticle(ControllableFireworkEffect parameters, ClientLevel world,
                                       double x, double y, double z,
                                       double velocityX, double velocityY, double velocityZ) {
            return new ControllableFireworkParticle(world,
