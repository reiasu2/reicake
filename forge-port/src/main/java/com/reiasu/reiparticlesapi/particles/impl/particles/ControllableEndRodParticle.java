...
public final class ControllableEndRodParticle extends ControllableParticle {
    private final SpriteSet provider;

    public ControllableEndRodParticle(ClientLevel world, Vec3 pos, Vec3 velocity,
    ...
    public static class Factory implements ParticleProvider<ControllableEndRodEffect> {
        private final SpriteSet provider;
        ...
        @Override
        public Particle createParticle(ControllableEndRodEffect parameters, ClientLevel world,
                                       double x, double y, double z,
                                       double velocityX, double velocityY, double velocityZ) {
            return new ControllableEndRodParticle(world,
